...
## โหมดแอดมิน (ปุ่ม Export / ล้างข้อมูล)

ปุ่ม "ส่งออกเป็น Excel" และ "ล้างคำตอบทั้งหมด" ถูกซ่อนไว้เสมอ ผู้เข้าร่วมทั่วไปจะไม่เห็น
ผู้ดูแล/พิธีกรงานเท่านั้นที่จะเห็นปุ่มเหล่านี้ได้ โดยเปิดเว็บด้วยลิงก์ที่มี `?admin=1` ต่อท้าย เช่น

```
https://ชื่อโปรเจกต์.vercel.app/?admin=1
```

ส่วนลิงก์ปกติที่แจกให้ผู้เข้าร่วม (ไม่มี `?admin=1`) จะไม่มีปุ่มเหล่านี้เลย
